    ...
    <div class="container h-100">
      ...
      <div class="row h-100 align-items-center">
        <div class="col-12 text-center">
          <h1 class="font-weight-white">Mi Menu</h1>
          <p class="lead">¿Qué vas a llevar hoy?</p>
        </div>
      </div>
    </div>
  </header>
<body>
    ...
    <section id="calientes">
      <h4>Caliente</h4><div class="divider"><span></span><span><i class="fas fa-mug-hot"></i></span><span></span></div>
      <div class="row row-cols-1 row-cols-md-2" id="caliente"></div>
    </section>

    <section id="frios">
      <h4>Frío</h4><div class="divider"><span></span><span><i class="fas fa-glass-whiskey"></i></span><span></span></div>
      <div class="row row-cols-1 row-cols-md-2" id="frio"></div>
    </section>
    <section id="reposterias">
      <h4>Repostería</h4><div class="divider"><span></span><span><i class="fas fa-cookie-bite"></i></span><span></span></div>
      <div class="row row-cols-1 row-cols-md-2" id="reposteria"></div>
    </section>
    <section id="bebidas">
      <h4>Bebidas</h4><div class="divider"><span></span><span><i class="fas fa-ice-cream"></i></span><span></span></div>
      <div class="row row-cols-1 row-cols-md-2" id="bebida"></div>
    </section>
    ...
    <section>
      <script>
        if($(window).scrollTop() > 40){
           ...
           <script src="platillos.js"></script>
    </section>
</body>
