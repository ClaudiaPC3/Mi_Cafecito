        ...
        <div class="card-columns">
            <div class="card text-center border-purple">
                <div class="card-body">
                  ...
                  <p class="card-text">Exclusivos, durante todo el año</p>
                </div>
              </div>
              <div class="card text-center border-purple">
                <div class="card-body">
                  ...
                  <p class="card-text">En la compra del café del día</p>
                </div>
              </div>
              <div class="card text-center border-purple">
                <div class="card-body">
                  <h4 class="card-title">Bebida de cumpleaños</h4>
                  <p class="card-text mbt-3"><i class="fas fa-hand-holding-usd fa-4x"></i></p>
                  <p class="card-text">Obten una bebida gratis de tu elección en tamaño mediano en tu cumpleaños</p>
                </div>
              </div>
              <div class="card text-center border-purple">
                <div class="card-body">
              ...
              <div class="card text-center border-purple">
                <div class="card-body">
                  ...
                  <p class="card-text">Trae a mas de 10 amigos y tus bebidas estarán al 50% de descuento</p>
                </div>
              </div>
              <div class="card text-center border-purple">
                <div class="card-body">
                  ...
                  <p class="card-text">Tienes la opción de participar en nuestros sorteos y ganarte desde tazas hasta un auto</p>
                </div>
              </div>
              <div class="card text-center border-purple">
                <div class="card-body">
              ...
              <div class="card text-center border-purple">
                <div class="card-body">
                  <h4 class="card-title">Aumenta el tamaño de tus bebidas</h4>
                  <p class="card-text mbt-3"><i class="fas fa-search fa-4x"></i></p>
                  <p class="card-text">Cada vez que contestes una encuesta de satisfacción</p>
                </div>
              </div>
              <div class="card text-center border-purple">
                <div class="card-body">
